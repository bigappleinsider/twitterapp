...
const item = {
  ...
  text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer condimentum molestie eleifend.',
}
...
describe('<Card> component', () => {
  ...
  it('should render date created', () => {
    expect(enzymeWrapper
      .find(CardHeader)
      .prop('subheader')
    ).toEqual(format(item.created_at,'MMMM DD, YYYY'));
  });
  ...
  it('should render user avatar', () => {
    ...
    expect(enzymeWrapper
      .find(Avatar)
      .prop('src')
    ).toEqual(item.user.profile_image_url);
  });
